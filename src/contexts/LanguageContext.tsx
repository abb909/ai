...
const translations = {
  en: {
    ...
    'landing.features.ai.desc': 'Powered by GPT-4 and cutting-edge machine learning algorithms',
    ...
    'landing.features.schools.desc': 'Technical, fundamental, momentum, and swing trading strategies',
  ...
  ar: {
    ...
    'landing.features.ai.desc': 'مدعوم بـ GPT-4 وخوارزميات التعلم الآلي المتطورة',
    'landing.features.secure.title': 'آمن وموثوق',
    'landing.features.secure.desc': 'أمان على مستوى البنوك مع ضمان وقت تشغيل 99.9%',
    'landing.features.schools.title': 'مدارس تداول متعددة',
    'landing.features.schools.desc': 'استراتيجيات التحليل الفني والأساسي والزخم والتداول المتأرجح',
  ...
  fr: {
    ...
    'landing.hero.subtitle': 'Obtenez des recommandations de trading intelligentes alimentées par une analyse IA avancée.',
    ...
    'landing.features.ai.desc': 'Alimenté par GPT-4 et des algorithmes d\'apprentissage automatique de pointe',
    ...
    'landing.features.schools.desc': 'Stratégies d\'analyse technique, fondamentale, momentum et swing trading',
  ...
  es: {
    ...
    'landing.hero.subtitle': 'Obtén recomendaciones de trading inteligentes impulsadas por análisis avanzado de IA.',
    ...
    'landing.features.ai.desc': 'Impulsado por GPT-4 y algoritmos de aprendizaje automático de vanguardia',
    'landing.features.secure.title': 'Seguro y Confiable',
    'landing.features.secure.desc': 'Seguridad de nivel bancario con garantía de tiempo de actividad del 99.9%',
    'landing.features.schools.title': 'Múltiples Escuelas de Trading',
    'landing.features.schools.desc': 'Estrategias de análisis técnico, fundamental, momentum y swing trading',
  ...
  de: {
    ...
    'landing.hero.subtitle': 'Erhalten Sie intelligente Trading-Empfehlungen durch fortschrittliche KI-Analyse.',
    ...
    'landing.features.ai.desc': 'Angetrieben von GPT-4 und modernsten Machine-Learning-Algorithmen',
    'landing.features.secure.title': 'Sicher und Zuverlässig',
    'landing.features.secure.desc': 'Banken-Level-Sicherheit mit 99,9% Verfügbarkeitsgarantie',
    'landing.features.schools.title': 'Mehrere Trading-Schulen',
    'landing.features.schools.desc': 'Technische, fundamentale, Momentum- und Swing-Trading-Strategien',
  ...
  it: {
    ...
    'landing.hero.subtitle': 'Ottieni raccomandazioni di trading intelligenti alimentate da analisi AI avanzata.',
    ...
    'landing.features.ai.desc': 'Alimentato da GPT-4 e algoritmi di machine learning all\'avanguardia',
    'landing.features.secure.title': 'Sicuro e Affidabile',
    'landing.features.secure.desc': 'Sicurezza di livello bancario con garanzia di uptime del 99,9%',
    'landing.features.schools.title': 'Scuole di Trading Multiple',
    'landing.features.schools.desc': 'Strategie di analisi tecnica, fondamentale, momentum e swing trading',
  ...
  hi: {
    ...
    'landing.hero.subtitle': 'उन्नत AI विश्लेषण द्वारा संचालित बुद्धिमान ट्रेडिंग सिफारिशें प्राप्त करें।',
    ...
    'landing.features.ai.desc': 'GPT-4 और अत्याधुनिक मशीन लर्निंग एल्गोरिदम द्वारा संचालित',
    'landing.features.secure.title': 'सुरक्षित और विश्वसनीय',
    'landing.features.secure.desc': 'बैंक-स्तरीय सुरक्षा के साथ 99.9% अपटाइम गारंटी',
    'landing.features.schools.title': 'कई ट्रेडिंग स्कूल',
    'landing.features.schools.desc': 'तकनीकी, मौलिक, मोमेंटम और स्विंग ट्रेडिंग रणनीतियां',
